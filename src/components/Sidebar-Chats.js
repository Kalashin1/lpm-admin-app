const SidebarChat = ({ users, setUser }) => {
  return (
    <div className="flex flex-col py-8 pl-6 pr-2 w-full lg:w-64 bg-white mb-8 flex-shrink-0">
      ...
      <div className="flex flex-col mt-8">
        ...
        <div className="flex h-2/4 flex-col space-y-1 mt-4 -mx-2 overflow-y-auto">
